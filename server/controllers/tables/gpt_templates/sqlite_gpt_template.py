def get_sqlite_gpt_input(db_schema: dict, user_sql: str, column_names: list) -> str:
...
You can find the actual database_names to fill into the "database_name" under the key "database" write after "metadata"
